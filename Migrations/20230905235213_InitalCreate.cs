    ...
    public partial class InitalCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 50, "This is a Bio", "Dude McDuderson" },
                    { 2, 53, "This is not a Bio", "Not Dude McDuderson" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "yes", 1, new TimeSpan(0, 0, 2, 30, 0), "no" },
                    { 2, "Maybe", 2, new TimeSpan(0, 0, 2, 45, 0), "possibly" }
                });
